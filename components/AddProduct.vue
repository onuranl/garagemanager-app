<template>
  <div class="modal is-active">
    ...
    <div class="modal-card" style="width: auto;">
        ...
        <card-component>
          <div class="columns is-variable">
            <div class="column">
              ...
              <b-field style="margin-bottom: 15px;" label="Stok No" horizontal>
                  ...
                  <div class="modal-card">
                    ...
                    <section class="modal-card-body">
                      <b-field
                        ...
                        horizontal
                      >
                        <b-input v-model="categoryName" name="name" required />
                      </b-field>
                    </section>
      ...
      <footer class="modal-card-foot">
        <b-button @click="addProduct" label="Ekle" type="is-primary" />
      </footer>
    </div>
  </div>
</template>
